...
```{r}
mmPlots <- NULL
mmPlots[[1]] <- cytofHist(doublets$doubletScore, sureDoublet, type = "count", 
          title = "Matched doublets")
mmPlots[[2]] <- cytofHist(doublets$doubletScore, sureDoublet, type = "density", 
          title = "Matched doublets")
...
```{r}
mmPlots <- NULL
mmPlots[[1]] <- cytofHist(debris$debrisScore, debm, type = "count", 
          title = "Mismatched debris")
mmPlots[[2]] <- cytofHist(debris$debrisScore, debm, type = "density", 
          title = "Mismatched debris")
